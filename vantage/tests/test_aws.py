"""Unit tests for vantage.aws using moto mocks."""
...
async def test_instance_with_name_tag():
    ...
    with patch("vantage.aws._get_ec2_instances", return_value=[inst]):
        from vantage.aws import list_instances
...
async def test_results_cached():
    ...
    with patch("vantage.aws._get_ec2_instances", side_effect=counting_ec2):
        from vantage.aws import list_instances
...
def test_name_from_tags_none():
    from vantage.aws import _name_from_tags
